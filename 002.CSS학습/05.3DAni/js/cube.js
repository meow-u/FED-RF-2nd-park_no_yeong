...
/****************************** 
    ...
    변경시킨다.
    3. 다시 "멈춰!" 버튼 클릭시 돌고있던
    큐브의 애니메이션 설정상태를 변경하여
    멈추게 한다. (버튼은 다시 "돌아!"로 변경)
...
// 대상: .bingo -> btngo 변수
// 이벤트 속성에 익명함수를 할당하면 
// 이벤트 발생시 익명함수 내부의 코드가 실행 됨!

btngo.onclick = function(){
    /* 함수 호출확인 (this는 버튼 자신) */
    console.log('선택확인 this! :',this, '\n', '이너텍스트읽기:',this.innerText);
    
    // 2. 변경대상 .cube -> cube변수
    // 3. 변경내용: 큐브에 클래스 on을 없으면 넣고
    //    있으면 제거한다. 
    //    ->미리셋팅된 애니 작동멈춤
