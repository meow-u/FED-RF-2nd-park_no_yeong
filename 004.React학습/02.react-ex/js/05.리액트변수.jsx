...
// 이변수를업데이트하면 여러가지 프로그래밍이 꼬인다!
// 그러므로 절대! 절대!절대! 변경되는 변수를 바깥쪽에 쓰지않는다!
// 리액트철칙
// (2) 단 변경되지 않는 데이터 const 변수나 공유함수등은 
// 컴포넌트 바깥에 코딩할수있다.
let what = "난뭐임?";
    ...
    (e) => {
      ...
      switch (txt) {
        ...
        case "이름바꿔 : useState":
          ...
          setStsName(val);
          //useState의 상태변수는 랜더링 직후에 변경됨 여기선변경안됨
