...
let aa = [11,22,33];
console.log('원본배열 aa:',aa)
// 배열변수 aa를 bb 할당!
let bb = aa;
console.log('bb 변경전 값: \naa',aa,'\nbb',bb);
...
// 배열의 깊은복사인 스프레드 연산자를 사용해서 할당
// let hh = [...gg]; - > 효과없음!

// 깊은복사방법은 기존 객체배열값을 문자화하고 다시 객체화한다!
// -> JSON.parse(JSON.stringify(배열값))
// parse()메서드는 구분을 분석하여 원래 구문 
// 형식으로 변환해주는 역할을 하는 메서드임!

// stringify() 메서드는 어떤값이든 문자화하여 변환해줌!
