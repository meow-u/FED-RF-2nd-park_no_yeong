 ...
 *********************************************************/
  ...
  /* 
 e.touches는 현재 화면에 유지되는 터치 정보
 e.changedTouches이벤트에서 변경된 터치 정보 (끝났거나 시작했거나 )

touchend 이벤트시  e.changedTouches 사용해야함 
-> e.touches에는 이미 끝난 터치 정보가 포함 X
 */
   ...
   function touchEndFn(e) {
     ...
     console.log('터치끗',mPosEnd, "차이수:", diffValue);
   } /////////// touchEndFn 함수 ////////////
 } ///////////// autoScrollFn 함수 //////////////
