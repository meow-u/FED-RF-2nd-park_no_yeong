...
// [ ★ 공통함수 불러오기 ]
//  ( 딱하나만 디폴트로 보내면 이름을 myFn말고 쓰고픈거 아무거나해도댐)
...
console.log
(txtData, txtData.mTitle ,  txtData.myObj.name ,  txtData.myFunc('개발자'));
//_______________________________________________________


// [ ★ export default로 내보낸 단일함수 불러오기 ]
...
// (1) 내용 넣기 : 이름과 나이를소개하는 메세지 넣기
contBox.innerHTML = makeMsg('공유',46);
contBox.innerHTML += makeMsg('노영쓰',31);
contBox.innerHTML += makeMsg('고양이 미유',7);

// (2) 이름과 나이가 배열로셋팅된 personInfo 배열을 순회하여 
// 메세지 함수를 호출해서 메세지를 찍어준다!
...
//       // console.log('v는 각각의 배열',v);
//   });

// (3) 영화정보 뿌리기
// ol>li형식으로 .mvpart 박스에 영화정보를 구성함 
// 데이터는 txtData.mvData 배열임!
mvBox.innerHTML = "<h2>♥ 영화 위시 리스트 ♥</h2>";
