  ...
  ******************************************/
   ...
   const submitFn = () => {
      ...
      if (mode == "M") {
         ...
         // 원본 데이터를 조회하여 기존 데이터를 업데이트 함!

         // find()는 특정항목을찾아서 리턴하여 데이터를 가져오기도 하지만
         // 업데이트 등 작업도 가능함!
         baseData.find((v) => {
            ...
            if (v.idx == currIdx) {
               ...
               // 추가항목 : (원래는 확정된 DB스키마에 따라 입력해야 하지만 우리가 사용하는 로컬 스토리지의 확장성에 따라 필요한 항목을 추가하여 넣는다!)
               // (3) 수정일 : mdata
               ...
               <tr>
                  ...
                  <td>
                     <input
                        ...
                        size="60"
                        readOnly
                        value={data.tit +  (data.mdate? ` (수정일:${data.mdate})` : "")}
                     />
                  </td>
               </tr>
               <tr>
