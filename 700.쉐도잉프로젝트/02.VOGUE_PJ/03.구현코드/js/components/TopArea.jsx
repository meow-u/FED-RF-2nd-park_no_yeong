         ...
         <header className="top-area ibx common-area">
            ...
            <div className="tmenu">
               ...
               <div className="sns">
                  ...
                  <a href="#" className="fi fi-laptop" 
                  title="로그인" onClick={()=>chgMenuFn('login')}>
                     <span className="ir">로그인</span>
                  </a>
                  <a href="#" className="fi fi-user-secret" 
                  title="회원가입" onClick={()=>chgMenuFn('member')}>
