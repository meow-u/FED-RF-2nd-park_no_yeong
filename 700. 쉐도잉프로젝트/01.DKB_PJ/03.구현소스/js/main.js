...
(() => {
   ...
   // 데이터 원본의 정렬을 내림차순으로 변경!( 콘솔에 sort 찍어도 대상배열바뀜 ㅎㄷㄷ)
   // console.log(
...
(() => {
   ...
   // 데이터 확인
   // console.log(hcode);
   // console.log('대상:',liveBox,'현장포토data:', lvData);
...
(() => {
   ...
   // 데이터 확인
   // console.log(hcode);
   // console.log('대상:',liveBox,'대표이미지data:', pData);
